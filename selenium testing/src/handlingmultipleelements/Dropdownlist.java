	...
	driver.get("https://courses.letskodeit.com/practice");
		...
		WebElement bmwbutton =driver.findElement(By.id("bmwradio"));
		 ...
		 //step1 identify dropdown
           ...
           System.out.println(skilldropdown.isDisplayed()+":"+skilldropdown.isEnabled());
           System.out.println("selected option is multiselected"+skillselect.isMultiple());
